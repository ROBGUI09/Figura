...
public class Configs {
	...
	public static final ConfigType.PositiveIntConfig
            PARTS_DEPTH_LIMIT = new ConfigType.PositiveIntConfig("parts_depth_limit", RENDERING, 15);
	public static final ConfigType.PositiveIntConfig
            STRING_REP_MAX_LENGTH = new ConfigType.PositiveIntConfig("string_rep_max_length", SCRIPT, 32767);
	public static final ConfigType.PositiveIntConfig
